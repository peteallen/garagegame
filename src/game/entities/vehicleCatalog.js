export const VEHICLE_CATALOG = Object.freeze({
  ...
  pickup: Object.freeze({
    ...
    speed: 184, minTurnRadius: 112, weight: 1, horn: 'horn_pickup', engine: 'engine_pickup', backupBeep: true,
  }),
  taxi: Object.freeze({
  ...
  fire: Object.freeze({
    ...
    speed: 160, minTurnRadius: 132, weight: 0.7, horn: 'horn_fire', engine: 'engine_heavy', large: true, backupBeep: true,
  }),
  icecream: Object.freeze({
    name: 'ice cream truck', color: '#8fdad0', accent: '#ff9eb5', length: 184, width: 102,
    speed: 168, minTurnRadius: 120, weight: 0.8, horn: 'horn_icecream', engine: 'engine_small', special: 'jingle', backupBeep: true,
  }),
  ev: Object.freeze({
  ...
  bus: Object.freeze({
    ...
    speed: 148, minTurnRadius: 152, weight: 0.75, horn: 'horn_bus', engine: 'engine_heavy', large: true, backupBeep: true,
  }),
});
...
export const TOW_TRUCK_CONFIG = Object.freeze({
  ...
  speed: 172, minTurnRadius: 125, horn: 'horn_tow', engine: 'engine_heavy', backupBeep: true,
});
